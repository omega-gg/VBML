...
As a result, it's mostly designed for a [Video Browser](http://omega.gg/MotionBox/VideoBrowser) (like [MotionBox](http://omega.gg/MotionBox)), but it might be useful in different scenarios.<br>
